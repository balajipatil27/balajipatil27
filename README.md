...
- 🎯 **SmartAnalysis** – An interactive ML Visualizer and Quiz app for beginners  
- 📊 **EDA Web App** – Upload datasets, perform EDA, and visualize insights  
- 🤖 **SmartLecture** – AI-powered lecture summarizer and query bot using NLP  
- 📈 **Career Recommender** – A smart ML-powered system that recommends jobs & skills  
